...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=AddCustom", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp", "javax.portlet.name=" + AddCustomPortletKeys.ADDCUSTOM,
...
public class AddCustomPortlet extends MVCPortlet {
	public void addPanNumber(ActionRequest actionRequest, ActionResponse actionResponse) throws PortalException {
		...
		ExpandoColumn col = ExpandoColumnLocalServiceUtil.getColumn(companyId, classNameId, expandoTable.getName(),
				"Pan Number");
		ExpandoValueLocalServiceUtil.addValue(classNameId, expandoTable.getTableId(), col.getColumnId(),
				themeDisplay.getUserId(), panNumber);
	}
